  ...
  return (
    <div className='flex flex-col md:flex-row-reverse py-16 justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 w-full'>
            ...
            <button className="bg-yellow-500 text-black px-12 py-2 rounded-md text-base font-secondary font-bold hover:bg-yellow-600 hover:text-white transition-all duration-200 cursor-pointer">Subscribe</button>
        </div>
